...
class TestgetAccuVerifiersCount:
    ...
    def test_AC_IN_018_to_025(self, new_genesis_env, clients_consensus):
        ...
        print('stop', pip.node.node_mark)
        pip.node.stop()
        pip_test.economic.wait_consensus(pip_test.node, 2)
        print(pip_test.node.ppos.getVerifierList())
        ...
        print('clients_consensus[1]', clients_consensus[1].node.node_mark)
    ...
    def test_AC_IN_001_002_004_to_006_012_to_014(self, new_genesis_env, clients_consensus):
        ...
        for index in range(3):
            ...
            client = clients_consensus[index]
            print(client.node.block_number)
...
class TestListGovernParam:
    ...
    def test_IN_LG_001(self, client_noconsensus):
        ...
        assert set(name) == {'duplicateSignReportReward','increaseIssuanceRatio','maxBlockGasLimit','maxEvidenceAge','maxValidators','minimumRelease','operatingThreshold','rewardPerChangeInterval','rewardPerMaxChangeRange','slashBlocksReward','slashFractionDuplicateSign','stakeThreshold','unDelegateFreezeDuration','unStakeFreezeDuration','zeroProduceCumulativeTime','zeroProduceFreezeDuration','zeroProduceNumberThreshold'}
