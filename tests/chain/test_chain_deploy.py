...
def test_start_all_node(global_test_env):
    ...
    """
    log.info("部署{}节点".format(len(global_test_env.collusion_node_config_list)))
    global_test_env.deploy_all()
...
def test_start_mini_node(global_test_env):
    ...
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[0:num], genesis_file=global_test_env.cfg.genesis_file)
    global_test_env.check_block(node_list=global_test_env.collusion_node_list[0:num])
...
def test_start_all_node_close_f(global_test_env):
    ...
    global_test_env.check_block(need_number=100, multiple=2,
...
def test_start_2f1_node_and_start_one(global_test_env):
    ...
    global_test_env.check_block()
    time.sleep(50)
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[num:num+1], genesis_file=global_test_env.cfg.genesis_file)
    global_test_env.check_block(need_number=50, multiple=2, node_list=global_test_env.collusion_node_list[0:num+1])
...
def test_start_2f(global_test_env):
    ...
    num = int(2 * global_test_env.max_byzantium + 1)
    log.info("部署{}个节点".format(num))
    test_nodes = global_test_env.collusion_node_list[0:num]
    global_test_env.deploy_nodes(test_nodes, genesis_file=global_test_env.cfg.genesis_file)
    time.sleep(10)
...
def test_start_all_node_close_f_add_1(global_test_env):
    ...
    """
    global_test_env.deploy_all()
    test_nodes = global_test_env.collusion_node_list[:global_test_env.max_byzantium+1]
    global_test_env.stop_nodes(test_nodes)
    running_node = global_test_env.collusion_node_list[global_test_env.max_byzantium+1:]
    time.sleep(5)
...
def test_start_2f_after_one(t, global_test_env):
    ...
    test_nodes = global_test_env.collusion_node_list[0:num+1]
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[0:num], genesis_file=global_test_env.cfg.genesis_file)
    time.sleep(t)
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[num:num+1], genesis_file=global_test_env.cfg.genesis_file)
    global_test_env.check_block(node_list=test_nodes, multiple=4)
...
def test_start_2f_after_all(t, global_test_env):
    ...
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[num:], genesis_file=global_test_env.cfg.genesis_file)
    global_test_env.check_block(node_list=global_test_env.collusion_node_list, multiple=4)
...
def test_up2f_after_other(global_test_env):
    ...
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[num:], genesis_file=global_test_env.cfg.genesis_file)
    while i <= 30:
        global_test_env.reset_nodes(global_test_env.collusion_node_list[num:])
        i += 1
    global_test_env.check_block(global_test_env.collusion_node_list)
...
def test_start_all_node_close_f_add_1_and_all(global_test_env):
    ...
    """
    global_test_env.deploy_all()
    test_nodes = global_test_env.collusion_node_list[0:global_test_env.max_byzantium+1]
    global_test_env.stop_nodes(test_nodes)
...
def test_start_all_node_close_f_add_1_and_one(global_test_env):
    ...
    global_test_env.check_block(node_list=global_test_env.collusion_node_list[global_test_env.max_byzantium:])
...
def test_start_all_node_close_f_add_1_and_fast_one(global_test_env):
    ...
    global_test_env.stop_nodes([test_node])
    new_cfg = copy(global_test_env.cfg)
    new_cfg.syncmode = "fast"
    test_node.cfg = new_cfg
    test_node.deploy_me(genesis_file=new_cfg.genesis_file)
    time.sleep(10)
