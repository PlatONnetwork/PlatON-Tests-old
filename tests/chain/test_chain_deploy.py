...
def test_start_mini_node(global_test_env):
    ...
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[0:num], genesis_file=global_test_env.cfg.genesis_tmp)
    global_test_env.check_block(multiple=num, node_list=global_test_env.collusion_node_list[0:num])
...
def test_start_2f1_node_and_start_one(global_test_env):
    ...
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[num:num+1], genesis_file=global_test_env.cfg.genesis_tmp)
    global_test_env.check_block(need_number=start+10, multiple=2, node_list=global_test_env.collusion_node_list[0:num+1])
...
def test_start_2f_after_all(t, global_test_env):
    ...
    global_test_env.deploy_nodes(global_test_env.collusion_node_list[num:], genesis_file=global_test_env.cfg.genesis_tmp)
    global_test_env.check_block(node_list=global_test_env.collusion_node_list, multiple=5)
...
def test_up2f_after_other(global_test_env):
    ...
    while i <= 30:
        ...
        i += 1
    global_test_env.check_block(node_list=global_test_env.collusion_node_list)
...
def test_start_all_node_close_f_add_1_and_one(global_test_env):
    ...
    global_test_env.check_block(multiple=5, node_list=global_test_env.collusion_node_list[global_test_env.max_byzantium:])
